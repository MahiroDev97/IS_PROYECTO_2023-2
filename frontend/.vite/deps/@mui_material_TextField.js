...
var Menu3 = React95.forwardRef(function Menu4(inProps, ref) {
  ...
  let activeItemIndex = -1;
  React95.Children.map(children2, (child, index2) => {
...
var NativeSelectInput = React96.forwardRef(function NativeSelectInput2(props, ref) {
  ...
  return (0, import_jsx_runtime71.jsxs)(React96.Fragment, {
...
var SelectInput = React97.forwardRef(function SelectInput2(props, ref) {
  ...
  const childrenArray = React97.Children.toArray(children2);
  const handleChange = (event) => {
...
var SvgIcon = React98.forwardRef(function SvgIcon2(inProps, ref) {
  ...
  const hasSvgAsChild = React98.isValidElement(children2) && children2.type === "svg";
  const ownerState = _extends({}, props, {
    color,
    component,
    fontSize,
...
var Select3 = React101.forwardRef(function Select4(inProps, ref) {
  ...
  return (0, import_jsx_runtime78.jsx)(React101.Fragment, {
