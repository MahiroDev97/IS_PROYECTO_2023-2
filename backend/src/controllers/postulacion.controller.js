...
async function updatePostulacion(req, res) {
    try {
        ...
        const [postulacion, errorPostulacion] = await PostulacionService.updatePostulacion(params.id, body);
...
async function deletePostulacion(req, res) {
    try {
        ...
        const [postulacion, errorPostulacion] = await PostulacionService.deletePostulacion(params.id);
